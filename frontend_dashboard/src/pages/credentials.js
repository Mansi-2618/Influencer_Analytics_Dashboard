            ...
            {showGuide && (
              <div className="mb-6 p-6 bg-[#0d9488]/30 border-2 border-[#5eead4]/40 rounded-xl animate-fadeIn">
                ...
                <ul className="text-sm text-red-500 list-disc pl-5">
                  <li>
                    The User Access Token is valid for 60 days only. After 60 days, it will expire automatically, and you must generate a new User Access Token every 60 days to continue using the system without interruption.
                  </li>
                  <li>
                    The Page Access Token does not expire, as long as the User Access Token and its permissions remain valid.
                  </li>
                </ul>
              </div>
            )}
